...
socket.on('opponent-move', moveInfo => {
  document.querySelector(`#${moveInfo.move}>.rightColumn`).innerHTML = moveInfo.score;
  document.getElementById('opponentScore').innerHTML = `${moveInfo.opponentScore} points`;
  toggleTurns();
  toggleDice('hide');
});
